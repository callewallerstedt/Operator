#!/usr/bin/env python3
"""EasyOCR test script for a single image (free OCR)."""
...
try:
    ...
    raise SystemExit(
        "easyocr is required. Install with: python -m pip install easyocr"
    ) from exc
...
def main() -> int:
    parser = argparse.ArgumentParser(description="Test EasyOCR on a single image.")
    ...
    # EasyOCR reader (Swedish + English)
